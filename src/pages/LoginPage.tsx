  ...
  return (
    <main className="grid min-h-screen bg-stone-950 lg:grid-cols-[1.1fr_0.9fr]">
      <section className="relative hidden overflow-hidden p-12 lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="relative flex items-center gap-3"><img src="/assets/kova-logo.webp?v=2026082303" alt="KOVA" className="size-11 object-contain" /><div><p className="font-display text-xl font-extrabold text-white">KOVA</p><p className="text-[10px] font-bold uppercase tracking-[0.25em] text-stone-500">Control</p></div></div>
      ...
      <section className="flex min-h-screen items-center justify-center bg-kova-50 px-5 py-10 sm:px-10">
        <div className="w-full max-w-md">
          <div className="mb-9 flex items-center gap-3 lg:hidden"><img src="/assets/kova-logo.webp?v=2026082303" alt="KOVA" className="size-10 object-contain" /><div><p className="font-display font-extrabold">KOVA</p><p className="text-[9px] font-bold uppercase tracking-[0.25em] text-stone-400">Control</p></div></div>
          <div className="mb-7">
